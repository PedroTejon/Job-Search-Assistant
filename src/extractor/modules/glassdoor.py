...
with open('src/data/cookies.json', 'rb') as cookies_f:
...
def job_listings_request(cursor: dict, request_body: list[dict]) -> Response:
    ...
    return post('https://www.glassdoor.com.br/graph', session, request_body)
                ...
                [
                    {
                        ...
                        'variables': {
                            ...
                            'filterParams': [
                                {'filterKey': 'companyId', 'values': company.platforms['glassdoor']['id']}
                            ],
                            'keyword': '',
                            'locationId': 0,
                            'numJobsToShow': 50,
