...
urlpatterns = [
    path('update_listing_details', views.update_listing_details, name='update_listing_details'),
    ...
    path('update_extraction_filters', views.update_extraction_filters, name='update_extraction_filters'),
]
