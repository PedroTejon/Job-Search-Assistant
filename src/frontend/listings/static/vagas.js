...
function search() {
  ...
  // eslint-disable-next-line max-len
  let url = `http://localhost:8000/jobs/?page=1&listing=[${getApplied},${getDismissed},${getNew},${getLocal},${getRemote},${getFollowedCompaniesOnly},${getOpen},${getClosed}]&sort=["${getSortType}","${getSortDirection}"]`;
  if (searchValue !== '') {
